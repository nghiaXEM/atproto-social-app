...
export const STAGING_SERVICE = ENV_STAGING_SERVICE ?? 'https://staging.bsky.dev'
export const BSKY_SERVICE = ENV_BSKY_SERVICE ?? 'https://bsky.social'
export const BSKY_SERVICE_DID = ENV_BSKY_SERVICE_DID ?? 'did:web:bsky.social'
export const PUBLIC_BSKY_SERVICE =
  ENV_PUBLIC_BSKY_SERVICE ?? 'https://public.api.bsky.app'
export const DEFAULT_SERVICE = BSKY_SERVICE
const HELP_DESK_LANG = 'en-us'
export const HELP_DESK_URL =
  ENV_HELP_DESK_URL ?? `https://blueskyweb.zendesk.com/hc/${HELP_DESK_LANG}`
export const EMBED_SERVICE = ENV_EMBED_SERVICE ?? 'https://embed.bsky.app'
export const EMBED_SCRIPT = `${EMBED_SERVICE}/static/embed.js`
export const BSKY_DOWNLOAD_URL =
  ENV_BSKY_DOWNLOAD_URL ?? 'https://bsky.app/download'
...
export const BSKY_APP_ACCOUNT_DID =
  ENV_APP_ACCOUNT_DID ?? 'did:plc:z72i7hdynmk6r22z27h6tvur'
